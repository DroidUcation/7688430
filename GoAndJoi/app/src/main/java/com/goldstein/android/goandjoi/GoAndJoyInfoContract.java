...
public class GoAndJoyInfoContract {
    ...
    public static final Uri CONTENT_URI = Uri.parse(PLACE_URI);
    ...
    public static final String CREATE_EXTENDED_PLACES_TABLE = "CREATE TABLE "+ ExtendedPlacesEntry.TABLE_NAME +" (" +
            ...
            ExtendedPlacesEntry.COLUMN_DURATION_TIME_TYPE +"  TEXT, " +
            ExtendedPlacesEntry.COLUMN_ACCESSIBILITY_TYPE +" TEXT," +
            ExtendedPlacesEntry.COLUMN_TRIP_TYPE +" TEXT " +
            ExtendedPlacesEntry.COLUMN_TRIP_LEVEL_TYPE +" TEXT " +
            ")";
    ...
    {
        public static final String TABLE_NAME ="ExtendedTripInfo";
