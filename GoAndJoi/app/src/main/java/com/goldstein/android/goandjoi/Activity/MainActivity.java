...
import com.goldstein.android.goandjoi.TwitterOAuthActivity;
...
@Override
    ...
    public void onClick(View v) {
        String uri = "geo:0,0?q=my+street+address" ; //String.format(Locale.ENGLISH, "geo:%f,%f", latitude, longitude);
