...
import com.goldstein.android.goandjoi.models.GStemViewHolder;
...
public class GSAdapter extends RecyclerView.Adapter<GStemViewHolder> {
    public List<PlaceModel> mPlaceModel;
    public static String currentLocation;
    private Context context;

    public GSAdapter(List<PlaceModel> mPlaceModel) {
        this.mPlaceModel = mPlaceModel;
        //      this.mOriginalCountryModel = mCountryModel;
    }
    @Override
    public void onBindViewHolder(GStemViewHolder itemViewHolder, int i) {
        final PlaceModel model = mPlaceModel.get(i);
        itemViewHolder.bind(model);
    }
    @Override
    public GStemViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        context = viewGroup.getContext();
        View view = LayoutInflater.from(context).inflate(R.layout.vw_gas_station, viewGroup, false);

        loadLocation();

        return new GStemViewHolder(view);
    }
    @Override
